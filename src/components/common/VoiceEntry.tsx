                  ...
                  <div key={i} className="rounded-lg bg-muted/40 hover:bg-muted/60 transition px-3 py-2">
                    ...
                    <div className="flex items-center gap-2 pl-7">
                      ...
                      <div className="flex-shrink-0 flex items-center gap-1 w-16">
                        <span className="text-3xs text-muted-foreground w-6">Unit</span>
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-1.5">
            {EXAMPLE_PHRASES.map((ex, i) => (
              ...
              >
                <span className="text-3xs font-semibold text-muted-foreground bg-background px-1.5 py-0.5 rounded flex-shrink-0">
                  {ex.lang}
                </span>
